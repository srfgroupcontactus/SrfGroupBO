...
import {
  entitiesDeclarationProblem,
  fetchDeclarationProblem
} from "@store/declaration/slice";
export default function DeclarationProblem() {
  const dispatch = useDispatch();

  const entitiesDeclarationProblemSelector =
    useSelector(entitiesDeclarationProblem) ?? [];
    ...
    <div>
      ...
      <main className="container-main">
        <table className="border-collapse border border-slate-400 w-full">
          ...
          {entitiesDeclarationProblemSelector.map(
